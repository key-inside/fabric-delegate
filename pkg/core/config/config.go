...
import (
	...
	// "github.com/hyperledger/fabric-sdk-go/pkg/core"
)

var FromReader = config.FromReader
var FromFile = config.FromFile
var FromRaw = config.FromRaw
...
// // func FromReader(in io.Reader, configType string, opts ...config.Option) core.ConfigProvider {
// // 	return config.FromReader()
